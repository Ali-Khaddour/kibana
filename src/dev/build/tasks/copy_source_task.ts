  ...
  async run(config, log, build) {
    await copyAll(config.resolveFromRepo(), build.resolvePath(), {
      ...
      select: [
        ...
        `!src/core/server/core_app/assets/favicons/tda-favicon.distribution.png`,
        `!src/core/server/core_app/assets/favicons/tda-favicon.distribution.svg`,
        `!src/core/server/core_app/assets/favicons/fda-favicon.distribution.png`,
        '!src/test_utils/**',
        '!src/fixtures/**',
        '!src/cli/repl/**',
        '!src/cli/dev.js',
